                                        ...
                                        <table class="table mb-0 table-center invoice-tb" id="tblData">
                                            <thead class="bg-light">
                                                <tr>
                                                    ...
                                                    <th scope="col" class="text-left">Hr Name</th>
                                                    <th scope="col" class="text-left">Coupon</th>                          
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
                                                    ...
                                                    if ($conn->connect_error) {
                                                        ...
                                                        $sql = "SELECT id, name, email, contact, hrname, coupon FROM coupons";
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="text-sm-left">
                            <p class="mb-0">&#1042;© 2019-20 PadhHigh. Design with <i class="mdi mdi-heart text-danger"></i> by <a href="http://www.padhhigh.com/" target="_blank" class="text-success">PadhHigh</a>.</p>
                        </div>
                    </div>
                </div><!--end row-->
            </div><!--end container-->
