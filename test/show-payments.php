                                        ...
                                        <table class="table mb-0 table-center invoice-tb" id="tblData">
                                            <thead class="bg-light">
                                                <tr>
                                                    ...
                                                    <th scope="col" class="text-left">Code Value/Discount</th>
                                                    <th scope="col" class="text-left">Payment Status</th>
                                                    <th scope="col" class="text-left">Payment ID</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
                                                    ...
                                                    if ($conn->connect_error) {
                                                        ...
                                                        $sql = "SELECT id, name, email, contactno, amount, code_value, payment_status, payment_id FROM payments";
